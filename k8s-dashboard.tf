...
# I put in comment the code because it is not usefull for AKS cluster version kubernetes version is > 1.16.4
# If your cluster Kubernetes version is <1.16.x then uncomment block !!
#
